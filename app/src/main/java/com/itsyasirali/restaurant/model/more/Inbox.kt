                    ...
                    items(list) { item ->
                        Box(modifier = Modifier.background(gray2)){
                            Column(modifier = Modifier.align(Alignment.Center)) {
                                ...
                                {
                                    Icon(painter = painterResource(id = com.itsyasirali.restaurant.R.drawable.ic_circle), contentDescription = "", tint = orange)
                                    ...
                                    Column() {
                                        ...
                                        Row(modifier = Modifier
                                            ...
                                            Icon(painter = painterResource(id = com.itsyasirali.restaurant.R.drawable.ic_stare), contentDescription = "", tint = orange)
                                        }
                                    }
                                }
