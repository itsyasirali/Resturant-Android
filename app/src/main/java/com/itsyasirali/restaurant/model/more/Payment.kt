...
import com.itsyasirali.restaurant.ui.*
...
class Payment(override var icon: Int = 0, override var name: String = "") : More {
    ...
    override fun setContent() {
        val list = listOf(
            PaymentItem(com.itsyasirali.restaurant.R.drawable.visa, "123 456   789"),
            PaymentItem(com.itsyasirali.restaurant.R.drawable.visa, "123 456   789"),
            PaymentItem(com.itsyasirali.restaurant.R.drawable.visa, "123 456   789"),
        )
        Column {
            ...
            ButtonWithImage(
                ...
                image = com.itsyasirali.restaurant.R.drawable.ic_add,
                color = orange,
