package com.itsyasirali.restaurant.ui
...
import com.itsyasirali.restaurant.viewmodels.ResetPasswordViewModel
        ...
        actions = {
            if (action) {
                IconButton(
                    ...
                    Icon(
                        painter = painterResource(id = com.itsyasirali.restaurant.R.drawable.ic_cart),
                        contentDescription = "",
        ...
        navigationIcon = if (backIcon) {
            {
                IconButton(
                    ...
                    Icon(
                        painter = painterResource(id = com.itsyasirali.restaurant.R.drawable.ic_back),
                        contentDescription = "",
                        tint = primaryFontColor
                    )
                }
